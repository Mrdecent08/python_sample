...
def update_packages():
    command = "ANSIBLE_HOST_KEY_CHECKING=False ANSIBLE_STDOUT_CALLBACK=json ansible-playbook tasks/update-pkg.yml -u root --ask-pass --ssh-extra-args='-F /root/.ansible/ssh_config'"
    try:
